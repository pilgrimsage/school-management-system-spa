                                        ...
                                        <div class="border-bottom border-gray-100 mb-24 pb-24">
                                            <div class="flex-align gap-4">
                                                <a href="index.html#"
                                                    ...
                                                    Bose is requesting access to Design File - Final Project.
                                                </a>
                                            ...
                                            <div class="flex-align gap-6 mt-8">
                                                ...
                                                <div class="flex-align gap-4">
                                                    <p class="text-gray-900 text-sm text-line-1">Design brief
                                                        and
                                                        ideas.txt</p>
                                                    <span class="text-xs text-gray-200 flex-shrink-0">2.2
                                                        MB</span>
                                                </div>
                                            </div>
                    ...
                    <div class="card border border-gray-100 rounded-12 box-shadow-custom">
                        <div class="card-body">
                            <div class="flex-align gap-8 mb-20 pb-20 border-bottom border-gray-100">
                                ...
                                <div class="">
                                    <h4 class="mb-0"><?= esc($currentUser['name'] ?? '') ?: 'Employee' ?></h4>
                                    <p class="fw-medium text-13 text-gray-200"><?= esc($currentUser['email'] ?? '') ?></p>
                                </div>
                            </div>
                            <ul class="max-h-270 overflow-y-auto scroll-sm pe-4">
                                <li class="mb-4">
                                    <a href="employee/profile" class="nav_js
